...
rh.consts('DEFAULT_TOPIC', encodeURI("#index.html".substring(1)));
rh.consts('HOME_FILEPATH', encodeURI("index.html"));
rh.consts('START_FILEPATH', encodeURI('topic.htm'));
rh.consts('HELP_ID', '5D9D1D5D-AC7D-476B-AEFF-093CFFC66265' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "Kites");
model.publish(rh.consts('KEY_HEADER_TITLE_COLOR'), "#ffffff");
model.publish(rh.consts('KEY_HEADER_BACKGROUND_COLOR'), "#3BBCE0");
model.publish(rh.consts('KEY_HEADER_LOGO_PATH'), "template/IndigoResponsive_HTML5/logo.png");
model.publish(rh.consts('KEY_LAYOUT_FONT_FAMILY'), "\"Myriad Pro\", Verdana, Arial, sans-serif");
